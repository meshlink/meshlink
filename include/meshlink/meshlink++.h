...
namespace meshlink {
    ...
    /// A class describing an address for a Meshlink node.
    typedef meshlink_address_t address;
...
//        }
        ...
        */
         ...
         */
        bool add_canonical_addresses(node *node, const address *addresses, size_t nmemb) {
         ...
         */
        bool set_canonical_addresses(node *node, const address *addresses, size_t nmemb) {
