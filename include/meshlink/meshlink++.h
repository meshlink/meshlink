...
namespace meshlink {
     ...
     */
    typedef std::function<void(log_level_t level, const char *text)> global_log_cb_t;
    ...
    class canonical_address: public meshlink_canonical_address_t {
    };
...
//        }
    ...
    namespace impl
    {
        ...
        static global_log_cb_t global_log_cb = nullptr;
    }
