...
typedef struct meshlink_address meshlink_address_t;
 ...
 */
extern bool meshlink_add_canonical_addresses(meshlink_handle_t *mesh, meshlink_node_t *node, const meshlink_address_t *addresses, size_t nmemb);
