...
ANDROID_TOOLCHAIN_DIR=/opt/elear-solutions

#declare -a COMPILE_ARCHITECTURES=("armv7" "arm64" "x86" "x86_64")
declare -a COMPILE_ARCHITECTURES=("arm64")
...
do
    ...
    export ANDROID_TOOLCHAIN_ROOT="${ANDROID_TOOLCHAIN_DIR}/${COMPILER_DIR}"

    ANDROID_TOOLCHAIN_BIN="${ANDROID_TOOLCHAIN_ROOT}/bin"
    ANDROID_SYSROOT_DIR="${ANDROID_TOOLCHAIN_ROOT}/sysroot"
    ...
    export ANDROID_LD_LIB=${ANDROID_TOOLCHAIN_ROOT}/${COMPILER_PREFIX}/lib
